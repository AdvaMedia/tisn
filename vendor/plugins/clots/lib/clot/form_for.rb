...
module Clot
  ...
  class LiquidFormFor < LiquidForm
    ...
    def set_form_action(context)
      ...
      @model_user_action = "#{@model.dropped_class.to_s.downcase}_form_action"

      unless context['paths'].nil?
        unless context['paths'][@model_user_action].nil?
          @form_action = context['paths'][@model_user_action]
        end
      end
      
      unless @attributes['debug'].nil?
        @form_action = @model_user_action
      end
