	...
	*/	
    updateContent: function(updateOptions){
        ...
        switch(loadMethod){
            case 'fullajax':
                if (contentContainer == contentEl){
                    contentContainer.set('html','<p><strong>Loading...</strong></p>');
                }
...
MochaUI.extend({			   
	...
	*/
    saveWorkspace: function(){
        this.cookie = new Hash.Cookie('mochaUIworkspaceCookie', {
            duration: 3600
        });
        this.cookie.empty();
        MochaUI.Windows.instances.each(function(instance) {
	...
	*/
    loadWorkspace: function(){
        cookie = new Hash.Cookie('mochaUIworkspaceCookie', {
            duration: 3600
        });
