var HtmlRotateManager=new Class({
    initialize: function(options){
        this.options = $extend({
            wrapper_id:'admin_htmlrotate_wrapper',
            window_id:'admin_htmlrotate_window_content'
        }, options ||
        {});
...
var htmlrotateManager=null;
window.addEvent('domready',function(){
    htmlrotateManager=new HtmlRotateManager();
});