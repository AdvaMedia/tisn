...
//				text: ['<big>В«</big>','<big>В»</big>','<big>Г—</big>'],		// Set "previous", "next", and "close" button content (HTML code should be written as entity codes or properly escaped)
...
//			NonverBlaster
				...
				playerpath: '/javascripts/utils/NonverBlaster.swf',	// Path to NonverBlaster.swf
		...
		*/
		mediabox: function(_options, linkMapper, linksFilter) {
			linkMapper = linkMapper || function(el) {
				elrel = el.rel.split(/[\[\]]/);
				elrel = elrel[1];
				_options.isProtectedVideo = false;
				if (elrel.indexOf("potect") > 0){
					_options.isProtectedVideo = true;
				}
...
// FLV, MP4
				...
				mediaType = 'obj';
				mediaWidth = parseInt(mediaWidth) || options.defaultWidth;
				mediaHeight = parseInt(mediaHeight) || options.defaultHeight;
				if (options.useNB) {
					
					if (options.isProtectedVideo){ URL = URL+'.video';}
...
// MP3, AAC
				...
				mediaType = 'obj';
				mediaWidth = parseInt(mediaWidth) || options.defaultWidth;
				mediaHeight = parseInt(mediaHeight) || "20px";
